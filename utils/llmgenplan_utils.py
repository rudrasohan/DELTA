# Re-implemented utils code for the baseline approach LLM-GenPlan
...
class GeneralizedPlan:
    ...
    def filepath(self) -> Path:
        ...
        # filename = Path(tempfile.NamedTemporaryFile(
        #     delete=False, suffix=".py").name)
        # with open(filename, "w", encoding="utf-8") as f:
    ...
    def run(self, task: PDDLTask) -> List[str]:
        ...
        return module.get_plan(task.objects, task.init, task.goal)
